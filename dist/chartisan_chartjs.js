(function (global, factory) {
  ...
  (global = global || self, factory(global.chartisan = {}));
  ...
  */
  ...
  function (_Base) {
    ...
    function Chartisan() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Chartisan)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _createClass(Chartisan, [{
      ...
      key: "onBackgroundUpdate",
      value: function onBackgroundUpdate(data) {
        if (this.chart) {
          var _data$data;

          this.chart.options = _objectSpread2({}, this.chart.options, {}, data.options); // To update the data arrays, it need to be performed
          ...
          if (this.chart.data.datasets && ((_data$data = data.data) === null || _data$data === void 0 ? void 0 : _data$data.datasets)) {
       ...
       * @memberof Chartisan
       */
      value: function mutateArray(dest, src, action) {
        var i;
